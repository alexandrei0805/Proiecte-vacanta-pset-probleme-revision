...
```
Nu stiu daca am reusit sa o fac corect dar sper sa fie bine.
A fost o problema foarte grea din punct de vedere algoritmic si logic.


A doua problema:`Runoff`
```c
#include <csbootcamp.h>
#include <stdio.h>
#include <string.h>
...
```
Cred ca am reusit sa fac si aceasta problema care se leaga putin de cea de dinainte.
A fost si aceasta foarte grea incat mi-au venit greu ideile.
